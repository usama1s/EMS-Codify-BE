...
module.exports = {
    ...
    //             return modifiedAttendance;
    //         }else{
    //             return ("no attendances avalable")
    //         }
    //     } catch (error) {
    //         console.error("Error fetching manager attendance:", error);
    //         throw error;
    ...
    //                 // Push the clock record to ClockIn or ClockOut array based on clock type
    //                 if (clockType === 'CI') {
    ...
    //                 // Check if the progress record already exists in the attendanceRecord.Progress array
    //                 const isDuplicate = attendanceRecord.Progress.some(item =>
    //                     item.start_time === progressRecord.start_time &&
    //                     item.end_time === progressRecord.end_time &&
    //                     item.title === progressRecord.title &&
    //                     item.description === progressRecord.description
    //                 );
    
    //                 // If the progress record is not a duplicate, push it to the attendanceRecord.Progress array
    //                 if (!isDuplicate) {
